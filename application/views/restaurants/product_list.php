<div class="container cafe-item product_list_data hide">
							...
							<div class="row items">
								<?php foreach ($products as $key => $value){ ?>
										<div class="col s-4" id="<?php echo $value['id']; ?>">
										   <div class="itool2 product-item product-item--button" data-id="<?php echo $value['prod_id']; ?>" data-type="item" data-constructor="0">
										      <div class="product-item_image">
										         <div class="product-item_image_wrapper">
										            <img src="<?php echo base_url().'assets/images/restaurant/'.$value['url_name'].'/'.$value['url']; ?>" alt="<?php echo $value['name']; ?>">
										         </div>
										      </div>
